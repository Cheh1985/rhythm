...
<div class="set-pills"><?php foreach($session['sets'] as $set): ?><span><b><?= e(\App\Domain\Weight::text($set)) ?> ×<?= (int)$set['reps'] ?></b><small>RIR <?= e($set['rir']) ?></small></span><?php endforeach; ?></div>
