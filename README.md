...
- полная пользовательская backup-копия v1.4 JSON/ZIP с versioned program schedule slots, накопленным активным временем, событиями отдыха, checksum и строгим preview; restore совместим с v1.0–v1.3;
...
php tests/workout-ui-stage2.php
