...
После MVP добавлено встроенное руководство «Как пользоваться»: простой путь от импорта плана до итогов, расшифровка полей тренировки, инструкции по плаванию, установке PWA, offline-режиму и резервной копии. Руководство доступно с Dashboard и из настроек.
