...
final class TrainingQueryService
{
    ...
    private function programTemplateDetail(array $row, array &$issues): array
    {
        ...
        foreach ($exerciseRows as $exercise) {
            ...
            $exercises[] = [
                ...
                'weight_kg' => \App\Domain\Weight::toKg(isset($exercise['weight']) ? (float) $exercise['weight'] : null, $exercise['weight_unit'] ?? 'kg'),
    ...
    private function plannedExercise(array $row, bool $sessionProjection = false): array
    {
        ...
        $result = [
            ...
            'weight_value' => isset($row['planned_weight_value']) ? (float) $row['planned_weight_value'] : ($row['planned_weight_kg'] !== null ? (float) $row['planned_weight_kg'] : null), 'weight_unit' => $row['planned_weight_unit'] ?? 'kg',
