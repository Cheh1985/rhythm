...
$check(str_contains($files['worker'], "rhythm-shell-v10.10") && str_contains($files['worker'], "asset('./assets/workout-history.js')") && str_contains($files['worker'], "asset('./assets/exercises/generic.svg')"), 'версия app shell актуальна, новые модули и fallback кешируются');
