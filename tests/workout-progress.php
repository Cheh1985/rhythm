...
$check(str_contains($serviceWorker, "rhythm-shell-v10.7") && str_contains($serviceWorker, "rest-timer.js") && str_contains($serviceWorker, "push.js"), 'версия PWA-кеша и модули таймера/push обновлены');
