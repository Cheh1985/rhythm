...
$check(str_contains($serviceWorker, "rhythm-shell-v10.12") && str_contains($serviceWorker, "rest-timer.js") && str_contains($serviceWorker, "push.js") && str_contains($serviceWorker, "workout-history.js") && str_contains($serviceWorker, "workout-wheel.js") && str_contains($serviceWorker, "workout-carousel.js"), 'версия PWA-кеша и модули тренировки обновлены');
