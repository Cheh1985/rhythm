...
$check(str_contains($serviceWorker, "rhythm-shell-v10.8") && str_contains($serviceWorker, "rest-timer.js") && str_contains($serviceWorker, "push.js") && str_contains($serviceWorker, "workout-history.js"), 'версия PWA-кеша и модули тренировки обновлены');
