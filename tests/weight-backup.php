...
foreach (['1.0','1.1'] as $version) {
    ...
    unset($old['data']['exercise_weight_preferences']);
    ...
    if ($legacySet['weight_unit'] !== 'kg' || (float)$legacySet['weight_value'] !== 50.0) throw new RuntimeException('Legacy backup did not default to kg');
}
fwrite(STDOUT,"Weight backup v1.2 and legacy restore checks passed.\n");
