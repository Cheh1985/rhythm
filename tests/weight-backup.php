...
$source->exec("INSERT INTO rest_events(id,user_id,public_id,workout_session_id,session_exercise_id,exercise_set_id,duration_seconds,started_at,deadline_at,ended_at,outcome,trigger_kind,created_at) VALUES(110,1,'rest:backup',80,90,100,90,'2026-09-19 10:01:00','2026-09-19 10:02:30','2026-09-19 10:02:30','completed','timer_elapsed','2026-09-19 10:02:31')");
...
if ($destination->query('SELECT outcome FROM rest_events')->fetchColumn() !== 'completed') throw new RuntimeException('Rest event was not restored');
...
fwrite(STDOUT,"Backup v1.4 rest events, active timing, weight units and legacy restore checks passed.\n");
