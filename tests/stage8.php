...
$flow->exec("CREATE TABLE users(id INTEGER PRIMARY KEY,theme TEXT,updated_at TEXT,deleted_at TEXT NULL);CREATE TABLE workout_plans(id INTEGER PRIMARY KEY,user_id INTEGER,status TEXT,version INTEGER,updated_at TEXT);CREATE TABLE workout_sessions(id INTEGER PRIMARY KEY,user_id INTEGER,workout_plan_id INTEGER,status TEXT,version INTEGER,started_at TEXT,finished_at TEXT NULL,active_duration_seconds INTEGER NOT NULL DEFAULT 0,active_segment_started_at TEXT NULL,updated_at TEXT,deleted_at TEXT NULL,edited_after_completion INTEGER DEFAULT 0,edited_at TEXT NULL);CREATE TABLE exercise_sets(id INTEGER PRIMARY KEY,user_id INTEGER,workout_session_id INTEGER,version INTEGER,deleted_at TEXT NULL,edited_at TEXT NULL);CREATE TABLE body_measurements(id INTEGER PRIMARY KEY,user_id INTEGER,deleted_at TEXT NULL,updated_at TEXT);CREATE TABLE swimming_sessions(id INTEGER PRIMARY KEY,user_id INTEGER,version INTEGER,deleted_at TEXT NULL,updated_at TEXT);CREATE TABLE audit_logs(id INTEGER PRIMARY KEY AUTOINCREMENT,user_id INTEGER,entity_type TEXT,entity_id TEXT,action TEXT,before_json TEXT,after_json TEXT,ip_address TEXT,created_at TEXT)");
$flow->exec("INSERT INTO users VALUES(1,'system','2026-08-24',NULL),(2,'system','2026-08-24',NULL);INSERT INTO workout_plans VALUES(1,1,'in_progress',1,'2026-08-24');INSERT INTO workout_sessions (id,user_id,workout_plan_id,status,version,started_at,active_duration_seconds,active_segment_started_at,updated_at,deleted_at,edited_after_completion,edited_at) VALUES(1,1,1,'in_progress',1,'2026-08-24',0,'2026-08-24','2026-08-24',NULL,0,NULL),(2,1,1,'in_progress',1,'2026-08-24',0,'2026-08-24','2026-08-24',NULL,0,NULL),(3,2,1,'in_progress',1,'2026-08-24',0,'2026-08-24','2026-08-24',NULL,0,NULL);INSERT INTO exercise_sets (id,user_id,workout_session_id,version,deleted_at,edited_at) VALUES(1,1,2,1,NULL,NULL),(2,2,3,1,NULL,NULL);INSERT INTO body_measurements VALUES(1,1,NULL,'2026-08-24');INSERT INTO swimming_sessions VALUES(1,1,1,NULL,'2026-08-24')");
