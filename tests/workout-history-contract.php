...
$check(str_contains($html, 'В прошлый раз') && str_contains($html, '100 lb') && str_contains($html, '50 кг'), 'временная строка прошлого раза читает последний history_sessions');
