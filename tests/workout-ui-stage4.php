...
$check(str_contains($files['worker'], "rhythm-shell-v10.14") && str_contains($files['worker'], "asset('./assets/workout-carousel.js')"), 'модуль карусели добавлен в новую версию app shell');
