...
$check(str_contains($serviceWorker, 'SET_LOCALE') && str_contains($serviceWorker, 'offline.en.html') && str_contains($serviceWorker, "rhythm-shell-v10.12"), 'Service Worker хранит locale и кеширует EN shell');
