...
$check(str_contains($files['worker'], "rhythm-shell-v10.12") && str_contains($files['worker'], "asset('./assets/workout-wheel.js')"), 'новый модуль включён в обновлённый app shell');
