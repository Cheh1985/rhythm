...
CREATE TABLE rest_notification_jobs(id INTEGER PRIMARY KEY,user_id INTEGER,workout_session_id INTEGER,timer_id TEXT,status TEXT,lock_token TEXT NULL,locked_at TEXT NULL,updated_at TEXT);
...
INSERT INTO rest_notification_jobs VALUES(40,1,10,'rest:timer-0001','scheduled',NULL,NULL,'2026-09-19 10:00:00');
SQL);
...
if ($pdo->query("SELECT status FROM rest_notification_jobs WHERE id=40")->fetchColumn() !== 'cancelled') throw new RuntimeException('Completed rest did not cancel its pending push notification');
