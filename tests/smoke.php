...
$restTimerJs = (string) file_get_contents(dirname(__DIR__) . '/public/assets/rest-timer.js');
$offlineQueueJs = (string) file_get_contents(dirname(__DIR__) . '/public/assets/offline-queue.js');
$check(str_contains($workoutJs, 'session_version') && str_contains($restTimerJs, 'endAt') && str_contains($offlineQueueJs, 'client_action_id'), 'stage 3 autosave and timestamp timer');
